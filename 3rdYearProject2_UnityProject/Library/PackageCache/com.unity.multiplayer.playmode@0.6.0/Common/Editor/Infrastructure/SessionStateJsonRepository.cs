...
namespace Unity.Multiplayer.Playmode.Common.Editor
{
    class SessionStateJsonRepository<TKey, TState> where TState : class, new()
    {
        ...
        public SessionStateJsonRepository(StateRepositoryDelegates stateRepository, string key)
        {
        ...
        public virtual bool ContainsKey(TKey identifier) => m_States.ContainsKey(identifier);

        public virtual bool TryGetValue(TKey identifier, out TState value) => m_States.TryGetValue(identifier, out value);

        public virtual bool Create(TKey identifier, TState state)
        {
        ...
        public virtual bool Update(TKey identifier, Action<TState> update, out TState state)
        {
            if (m_States.ContainsKey(identifier))
            {
        ...
        public virtual bool Delete(TKey identifier)
        {
            if (m_States.ContainsKey(identifier))
            {
